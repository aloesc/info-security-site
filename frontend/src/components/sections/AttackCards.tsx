...
const ATTACKS: AttackData[] = [
  ...
  },
  {
    ...
    description:
      'Злоумышленники крадут cookie-файлы сессии через вредоносные браузерные расширения или перехватывая трафик в公共Wi-Fi сетях.',
    mitigation:
      'Не устанавливайте непроверенные расширения. Используйте VPN в公共сетях. Регулярно завершайте активные сессии в настройках аккаунта.',
  },
  {
    id: 'brute-force',
    title: 'Брутфорс',
